...
public class BootStrapData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (productRepository.count() == 0 && outsourcedPartRepository.count() == 0) {
            ...
            // Creating products with min and max inventory values
            Product youthStarterSet = new Product("Youth Hockey Set", 500, 30, 10, 100);
            Product starterHockeySet = new Product("Starter Hockey Set", 700, 10, 5, 50);
            Product advancedHockeySet = new Product("Advanced Hockey Set", 2500, 8, 2, 20);
            Product proHockeySet = new Product("Pro Hockey Set", 5000, 5, 1, 10);
            Product goalieSet = new Product("Goalie Set", 3000, 10, 5, 20);
